...
public class Delivery_registeration extends AppCompatActivity {
    ...
    String[] Colombo = {"Ratmalana", "M.t.Lavinia", "Moratuwa"};
    String[] Kalutara = {"Panadura", "Wadduwa", "Kalutara"};
    ...
    String fname, lname, emailid, password, confpassword, mobile, house, Area, Pincode, role = "DeliveryPerson", statee, cityy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Email = (TextInputLayout) findViewById(R.id.EmailidD);
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Delivery_registeration.this,Delivery_LoginPhone.class));
                finish();
            }
        });
    ...
    public boolean isValid() {
        ...
        boolean isValid=false, isValidname = false,isValidlname = false, isValidemail = false, isValidpassword = false, isValidconfpassword = false, isValidmobilenum = false, isValidarea = false, isValidhouseno = false, isValidpincode = false;
        ...
        isValid = (isValidarea && isValidconfpassword && isValidpassword && isValidpincode && isValidemail && isValidmobilenum && isValidhouseno && isValidname && isValidlname) ? true : false;
        return isValid;
