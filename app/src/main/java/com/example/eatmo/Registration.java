...
public class Registration extends AppCompatActivity {
    ...
    public boolean isValid() {
        ...
        boolean isValid=false, isValidname = false,isValidlname = false, isValidemail = false, isValidpassword = false, isValidconfpassword = false, isValidmobilenum = false, isValidarea = false, isValidlocaladd = false, isValidpincode = false;
        ...
        isValid = (isValidarea && isValidconfpassword && isValidpassword && isValidpincode && isValidemail && isValidmobilenum && isValidlocaladd && isValidname && isValidlname) ? true : false;
        return isValid;
