...
public class ChefLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            pass = (TextInputLayout)findViewById(R.id.LpasswordCh);
            Signin = (Button)findViewById(R.id.button4Ch);
            signup = (TextView) findViewById(R.id.textView3);
            Forgotpassword = (TextView)findViewById(R.id.forgotpassCh);
            Signinphone = (Button)findViewById(R.id.btnphoneCh);
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if(task.isSuccessful()){
                                    ...
                                    if(Fauth.getCurrentUser().isEmailVerified()){
                                        mDialog.dismiss();
                                        Toast.makeText(ChefLogin.this, "You Have Successfully Login", Toast.LENGTH_SHORT).show();
