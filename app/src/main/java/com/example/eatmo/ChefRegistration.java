...
public class ChefRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pincode = (TextInputLayout) findViewById(R.id.PincodeCh);
        Statespin = (Spinner) findViewById(R.id.StateeCh);
        Cityspin = (Spinner) findViewById(R.id.CitysCh);
        area = (TextInputLayout) findViewById(R.id.AreaCh);
